...
**Status:** implementada, validada localmente e aceita remotamente após autorização explícita. Maven/Checkstyle, 60 testes Java, ESLint/build, 25 testes frontend, auditoria npm, Compose e smokes Foundation/Catalog/Cart/Orders passaram em 2026-09-19; a [CommerceFlow CI 35474080958](https://github.com/JoaoMatheusVerissimo/commerceflow/actions/runs/35474080958) confirmou o commit `3be3f64`. Consulte [execução, APIs e limites](orders.md) e [ADR-013](decisions/ADR-013-orders-and-inventory.md).
