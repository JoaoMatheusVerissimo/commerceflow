  ...
  return <main className="min-h-screen bg-[#f3f5ef]">
    <header className="border-b border-[#dce2d8] bg-white px-6 py-4">
      <div className="mx-auto flex max-w-6xl items-center justify-between">
        <Link to="/" className="text-xl font-bold text-[#18361f]">CommerceFlow · Loja</Link>
    ...
    <section className="mx-auto max-w-6xl px-6 py-16">
      ...
      <p className="mt-6 max-w-2xl text-lg leading-8 text-[#637064]">Confira os dados do seu perfil ou <Link className="underline" to="/products">explore o catálogo</Link>.</p>
