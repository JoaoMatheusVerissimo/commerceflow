...
import com.commerceflow.inventory.web.ApiErrors;
...
public class SecurityConfig {
    @Bean JwtDecoder jwtDecoder(@Value("${spring.security.oauth2.resourceserver.jwt.jwk-set-uri}") String uri,
    ...
    @Bean SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        var roles = new JwtGrantedAuthoritiesConverter(); roles.setAuthoritiesClaimName("roles");
        ...
        return http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(a -> a
                        ...
                        .requestMatchers("/internal/reservations").hasRole("CUSTOMER")
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/admin/inventory/**")
                        .hasAnyRole("SELLER", "MANAGER", "ADMIN")
                        .requestMatchers("/admin/inventory/**").hasAnyRole("MANAGER", "ADMIN")
                        .anyRequest().denyAll())
